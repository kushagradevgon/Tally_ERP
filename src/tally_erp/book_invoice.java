 ...
 */
public class book_invoice extends javax.swing.JFrame {
String z;
String u;
String x;
String y;
...
String gstax;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{        
            ...
            while(rs.next()){
            x = rs.getString("book_name");
            y = rs.getString("publisher_name");
            z=  rs.getString("cost");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        conn c1 = new conn();
            ...
            String n  = "update stock set qty = '"+qty1+"' where ID= '"+a+"'";
            if(ab3==0)
            {   
...
txtbill.setText("========================"+"\n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(book_invoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new book_invoice().setVisible(true);
            }
        });
    }
