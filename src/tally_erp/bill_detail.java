 ...
 */
public class bill_detail extends javax.swing.JFrame {

    /**
     * Creates new form bill_detail
     */
    String Balance;
        String transaction;
        String amount;
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Another Payment:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
          ...
          String q  = "select * from bookbill where count = '"+c+"'";
            ResultSet rs  = c1.s.executeQuery(q);
           // User user;
            
            while(rs.next()){
    
                bill=rs.getString("billdetail");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String a2= jTextField4.getText();
         try{
        conn c1 = new conn();
        String n  = "update bookbill set Transaction = '"+transaction+","+t2+"' where count= '"+c+"'";
        int bal = Integer.parseInt(Balance);
        System.out.println(bal);
        int amt2 = Integer.parseInt(a2);
        int bal2= bal-amt2;
        String bal3=Integer.toString(bal2);
        String m  = "update bookbill set Balance = '"+bal3+"' where count= '"+c+"'";
        jLabel14.setText(bal3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bill_detail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
